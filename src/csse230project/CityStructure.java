...
public class CityStructure {
	...
	public void linkCity(String city1, String city2, int time, int distance) {
		Edge edge1 = new Edge(this.cityMap.get(city1), this.cityMap.get(city2), time, distance);
		Edge edge2 = new Edge(this.cityMap.get(city2), this.cityMap.get(city1), time, distance);
